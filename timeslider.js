L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(document).mouseup(function () {
            map.dragging.enable();
            //Hide the slider timestamp if not in range and then option alwaysShowDate will react if false
    ...
    onRemove: function (map) {
        //Delete all markers which were added via the slider and remove the slider div
